...
// TODO define position attribute
    @TemplateRegistration(folder = "Project/Processing", 
                          ...
                          iconBase = "org/netbeans/modules/java/processingproject/processinglogo.png", 
...
public class ProcessingSketchTemplateWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public ProcessingSketchTemplateWizardIterator() {
    }

    public static ProcessingSketchTemplateWizardIterator createIterator() {
        return new ProcessingSketchTemplateWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
            new ProcessingSketchTemplateWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(ProcessingSketchTemplateWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
    ...
    public Set/*<FileObject>*/ instantiate(/*ProgressHandle handle*/) throws IOException {
        ...
        resultSet.add(generateClassTemplate(dir.getName()));
        return resultSet;
    }
    ...
    private FileObject generateClassTemplate(String sketchlassname) throws MalformedURLException, DataObjectNotFoundException, IOException {
        ...
        FileObject targetFolder = FileUtil.toFileObject(new File(projectFolder + "/src/"));
        DataFolder df = DataFolder.findFolder(targetFolder);

        //Find the template in the System Filesystem:
        URL processingSketchClass = new URL("nbfs:/SystemFileSystem/Templates/Processing/Sketch.java");

        //Map the template to a FileObject:
        FileObject fo = URLMapper.findFileObject(processingSketchClass);
        ...
        DataObject dobj = dTemplate.createFromTemplate(df, sketchlassname + ".java", args);
